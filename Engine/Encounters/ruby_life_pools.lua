...
R(2606, {
    ...
    events = {
        ...
        { role = "tank", voice = "tank-buster", spellID = 372858, firstSeenSec = 28, cdSeriesSec = { 28, 40 }, severity = 0 },  -- Searing Blows | AMBIGU : durée 40 partagée  [vu 28×3 40×17]
    },
})
...
R(2609, {
    ...
    events = {
        ...
        { role = "other", voice = "prepare-aoe", spellID = 1307308, firstSeenSec = 15, cdSeriesSec = { 15, 24 }, severity = 1 },  -- Chillstorm | AMBIGU : durée 27 partagée  [vu 15×8 24×27]
    },
})
...
R(2623, {
    ...
    events = {
        ...
        { role = "other", voice = "watch-frontal", spellID = 381525, firstSeenSec = 1, cdSeriesSec = { 1, 16, 20 }, severity = 1 },  -- Roaring Firebreath | AMBIGU : durée 16 partagée  [vu 1×3 16×22 20×15]
