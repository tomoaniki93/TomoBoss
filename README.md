...
# ![TomoBoss](https://img.shields.io/badge/TomoBoss-v2.5.2-0cd29f?style=for-the-badge) ![WoW](https://img.shields.io/badge/WoW-Midnight-blue?style=for-the-badge) ![Interface](https://img.shields.io/badge/Interface-120007-orange?style=for-the-badge)

Minuteurs de boss + voix française pour World of Warcraft (Midnight, interface 12.0).
Interface sombre (dark black) et menthe.

**Pack audio français** : VoixFrancaise02 — 185 annonces, embarquées.
